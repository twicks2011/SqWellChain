...
#pragma omp critical
  ...
  */
  ...
  if(doSwaps == 1){ 
	...
	//!!!!!!!!!!!!!!!!!!!!!Need to update the Eswap array here???!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	  //***********New code (RSG) *************************************************************
	  double Eswap_temp = Eswap[secondSwapTemp];
	  Eswap[secondSwapTemp]=Eswap[firstSwapTemp];
	  Eswap[firstSwapTemp] = Eswap_temp;
	 
	   //***********End new code (RSG) *************************************************************
	   //!!!!!!!!!!!!!!!!!!!!! Also add a catious check here???!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
